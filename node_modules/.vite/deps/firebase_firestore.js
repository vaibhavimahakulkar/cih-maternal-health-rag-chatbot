...
// node_modules/@firebase/firestore/dist/common-341bda9b.esm.js
var User = class {
  constructor(e) {
    this.uid = e;
  }
...
var L = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
...
var __PRIVATE_SimpleDbTransaction = class ___PRIVATE_SimpleDbTransaction {
  ...
  abort(e) {
    e && this.S.reject(e), this.aborted || (__PRIVATE_logDebug(k, "Aborting transaction:", e ? e.message : "Client-initiated abort"), this.aborted = true, this.transaction.abort());
  }
  C() {
...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
   ...
   */
  async L(e) {
    return this.db || (__PRIVATE_logDebug(k, "Opening database:", this.name), this.db = await new Promise(((t, n) => {
      ...
      r.onsuccess = (e2) => {
        ...
        __PRIVATE_logDebug(k, 'Database "' + this.name + '" requires upgrade from version:', e2.oldVersion);
        const t2 = e2.target.result;
        this.N.k(t2, r.transaction, e2.oldVersion, this.version).next((() => {
          __PRIVATE_logDebug(k, "Database upgrade to version " + this.version + " complete");
        }));
      };
  ...
  async runTransaction(e, t, n, r) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        if (__PRIVATE_logDebug(k, "Transaction failed with error:", t2.message, "Retrying:", n2), this.close(), !n2) return Promise.reject(t2);
      }
    }
  }
  close() {
...
var __PRIVATE_SimpleDbStore = class {
  ...
  put(e, t) {
    let n;
    return void 0 !== t ? (__PRIVATE_logDebug(k, "PUT", this.store.name, e, t), n = this.store.put(t, e)) : (__PRIVATE_logDebug(k, "PUT", this.store.name, "<auto-key>", e), n = this.store.put(e)), __PRIVATE_wrapRequest(n);
  }
  /**
   ...
   */
  add(e) {
    __PRIVATE_logDebug(k, "ADD", this.store.name, e, e);
  ...
  get(e) {
    return __PRIVATE_wrapRequest(this.store.get(e)).next(((t) => (
      ...
      (void 0 === t && (t = null), __PRIVATE_logDebug(k, "GET", this.store.name, e, t), t)
    )));
  }
  delete(e) {
    __PRIVATE_logDebug(k, "DELETE", this.store.name, e);
   ...
   */
  count() {
    __PRIVATE_logDebug(k, "COUNT", this.store.name);
  ...
  X(e, t) {
    __PRIVATE_logDebug(k, "DELETE ALL", this.store.name);
...
var __PRIVATE_IndexBackfiller = class {
  ...
  se(e, t) {
    ...
    return PersistencePromise.doWhile((() => true === i && r > 0), (() => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next(((t2) => {
      if (null !== t2 && !n.has(t2)) return __PRIVATE_logDebug(q, `Processing collection: ${t2}`), this.oe(e, t2, r).next(((e2) => {
        r -= e2, n.add(t2);
      }));
      i = false;
    })))).next((() => t - r));
  ...
  oe(e, t, n) {
    return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next(((r) => this.localStore.localDocuments.getNextDocuments(e, t, r, n).next(((n2) => {
      const i = n2.changes;
      return this.localStore.indexManager.updateIndexEntries(e, i).next((() => this._e(r, n2))).next(((n3) => (__PRIVATE_logDebug(q, `Updating offset: ${n3}`), this.localStore.indexManager.updateCollectionGroup(e, t, n3)))).next((() => i.size));
    }))));
  }
...
function __PRIVATE_decodeResourcePath(e) {
  ...
  if (__PRIVATE_hardAssert(t >= 2, 64408, {
    path: e
  }), 2 === t) return __PRIVATE_hardAssert(e.charAt(0) === $ && "" === e.charAt(1), 56145, {
    path: e
...
var ne = ["prefixPath", "collectionGroup", "readTime", "documentId"];
var re = "documentKeyIndex";
var ie = ["prefixPath", "collectionGroup", "documentId"];
var se = "collectionGroupIndex";
var oe = ["collectionGroup", "readTime", "prefixPath", "documentId"];
var _e = "remoteDocumentGlobal";
var ae = "remoteDocumentGlobalKey";
var ue = "targets";
var ce = "queryTargetsIndex";
var le = ["canonicalId", "targetId"];
var he = "targetDocuments";
var Pe = ["targetId", "path"];
var Te = "documentTargetsIndex";
var Ie = ["path", "targetId"];
var Ee = "targetGlobalKey";
var Re = "targetGlobal";
var Ae = "collectionParents";
var Ve = ["collectionId", "parent"];
var de = "clientMetadata";
var me = "clientId";
var fe = "bundles";
var ge = "bundleId";
var pe = "namedQueries";
...
var be = "indexId";
var Se = "collectionGroupIndex";
var De = "collectionGroup";
var Ce = "indexState";
var ve = ["indexId", "uid"];
var Fe = "sequenceNumberIndex";
var Me = ["uid", "sequenceNumber"];
var xe = "indexEntries";
var Oe = ["indexId", "uid", "arrayValue", "directionalValue", "orderedDocumentKey", "documentKey"];
var Ne = "documentKeyIndex";
var Be = ["indexId", "uid", "orderedDocumentKey"];
var Le = "documentOverlays";
var ke = ["userId", "collectionPath", "documentId"];
var Ke = "collectionPathOverlayIndex";
var qe = ["userId", "collectionPath", "largestBatchId"];
var Ue = "collectionGroupOverlayIndex";
var $e = ["userId", "collectionGroup", "largestBatchId"];
var We = "globals";
var Qe = "name";
var Ge = [...[...[...[...[z, H, ee, W, ue, Q, Re, he], de], _e], Ae], fe, pe];
var ze = [...Ge, Le];
var je = [z, H, ee, te, ue, Q, Re, he, de, _e, Ae, fe, pe, Le];
var He = je;
var Je = [...He, we, Ce, xe];
var Ze = Je;
var Xe = [...Je, We];
...
var tt = "server_timestamp";
var nt = "__type__";
var rt = "__previous_value__";
var it = "__local_write_time__";
...
function __PRIVATE_valuesGetLowerBound(e) {
  return "nullValue" in e ? lt : "booleanValue" in e ? {
    ...
    arrayValue: {}
  } : "mapValue" in e ? __PRIVATE_isVectorValue(e) ? ht : {
    mapValue: {}
  } : fail(35942, {
    value: e
  });
...
function __PRIVATE_valuesGetUpperBound(e) {
  return "nullValue" in e ? {
    ...
    arrayValue: {}
  } : "arrayValue" in e ? ht : "mapValue" in e ? __PRIVATE_isVectorValue(e) ? {
    mapValue: {}
  } : at : fail(61959, {
    value: e
  });
...
var It = new SortedMap(DocumentKey.comparator);
var Et = new SortedSet(DocumentKey.comparator);
function __PRIVATE_documentKeySet(...e) {
  let t = Et;
  for (const n of e) t = t.add(n);
  return t;
}
var Rt = new SortedSet(__PRIVATE_primitiveComparator);
...
function __PRIVATE_setTestingHooksSpi(e) {
  if (dt) throw new Error("a TestingHooksSpi instance is already set");
  dt = e;
}
function __PRIVATE_newTextEncoder() {
  return new TextEncoder();
}
var mt = new Integer([4294967295, 4294967295], 0);
    ...
    if (r) {
      ...
      if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
        ...
        if (r2 !== n) {
          ...
          dt == null ? void 0 : dt.lt((function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r3, i3) {
            var _a, _b, _c;
            const s = {
              localCacheCount: e2,
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  kt(e, t) {
    ...
    const n = e.fields || {};
    this.Ft(t, 53);
    const r = ct, i = ((_b = (_a = n[r].arrayValue) == null ? void 0 : _a.values) == null ? void 0 : _b.length) || 0;
...
var __PRIVATE_OrderedCodeWriter = class {
  ...
  jt(e) {
    const t = e[Symbol.iterator]();
    let n = t.next();
    for (; !n.done; ) this.Ht(n.value), n = t.next();
    this.Jt();
  }
  ...
  Xt(e) {
    for (const t of e) {
      const e2 = t.charCodeAt(0);
      if (e2 < 128) this.Ht(e2);
      else if (e2 < 2048) this.Ht(960 | e2 >>> 6), this.Ht(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t) this.Ht(480 | e2 >>> 12), this.Ht(128 | 63 & e2 >>> 6), this.Ht(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
        this.Ht(240 | e3 >>> 18), this.Ht(128 | 63 & e3 >>> 12), this.Ht(128 | 63 & e3 >>> 6), this.Ht(128 | 63 & e3);
      }
    }
    this.Jt();
  }
  ...
  Gt(e) {
    const t = 255 & e;
    0 === t ? (this.sn(0), this.sn(255)) : t === yt ? (this.sn(yt), this.sn(0)) : this.sn(t);
  }
  /** Writes a single byte descending to the buffer.  */
  Ht(e) {
    const t = 255 & e;
    0 === t ? (this.an(0), this.an(255)) : t === yt ? (this.an(yt), this.an(0)) : this.an(e);
  }
  zt() {
    this.sn(0), this.sn(1);
  }
...
var __PRIVATE_IndexedDbIndexManager = class {
    ...
    return PersistencePromise.forEach(this.vn(t), ((t2) => this.Fn(e, t2).next(((e2) => {
      ...
      if (r) {
        ...
        return PersistencePromise.forEach(i, ((i2, s) => {
          __PRIVATE_logDebug(wt, `Using index ${(function __PRIVATE_fieldIndexToString(e3) {
  ...
  On(e, t, n, r, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.Nn(t[c / a]) : bt, l = this.Bn(e, _2, n[c % a], r), h = this.Ln(e, _2, i[c % a], s), P = o.map(((t2) => this.Bn(
        e,
        _2,
        t2,
        /* inclusive= */
  ...
  getFieldIndexes(e, t) {
    ...
    return (t ? n.H(Se, IDBKeyRange.bound(t, t)) : n.H()).next(((e2) => {
      const t2 = [];
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.Wn(e).next(((e2) => r.H(Se, IDBKeyRange.bound(t, t)).next(((t2) => PersistencePromise.forEach(t2, ((t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.uid, e2, n))))))));
  }
  updateIndexEntries(e, t) {
  ...
  Gn(e, t) {
    ...
    } else n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, bt, r));
    return n;
  }
  /**
   ...
   */
  zn(e, t, n, r, i) {
    __PRIVATE_logDebug(wt, "Updating index entries for document '%s'", t.key);
    const s = [];
  ...
  createRange(e, t, n) {
    ...
    for (let e2 = 0; e2 < r.length; e2 += 2) {
      if (this.Jn(r[e2], r[e2 + 1])) return [];
      const t2 = r[e2].An(this.uid, bt, DocumentKey.empty()), n2 = r[e2 + 1].An(this.uid, bt, DocumentKey.empty());
...
function removeMutationBatch(e, t, n) {
  const r = e.store(H), i = e.store(ee), s = [], o = IDBKeyRange.only(n.batchId);
  let _ = 0;
  const a = r.ee({
    range: o
...
var __PRIVATE_IndexedDbMutationQueue = class ___PRIVATE_IndexedDbMutationQueue {
  ...
  addMutationBatch(e, t, n, r) {
    ...
    return s.add({}).next(((o) => {
      ...
      for (const e2 of r) {
        ...
        c = c.add(e2.key.path.popLast()), u.push(s.put(a)), u.push(i.put(t2, Y));
      }
      return c.forEach(((t2) => {
  ...
  getAllMutationBatches(e) {
    ...
    return __PRIVATE_mutationsStore(e).H(Z, t).next(((e2) => e2.map(((e3) => __PRIVATE_fromDbMutationBatch(this.serializer, e3)))));
  }
...
var __PRIVATE_IndexedDbTargetCache = class {
  ...
  ur(e) {
    return __PRIVATE_globalTargetStore(e).get(Ee).next(((e2) => (__PRIVATE_hardAssert(null !== e2, 2888), e2)));
  }
  cr(e, t) {
    return __PRIVATE_globalTargetStore(e).put(Ee, t);
  }
  lr(e, t) {
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r, i) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).H(IDBKeyRange.bound(o, _, true)).next(((e2) => {
      i == null ? void 0 : i.incrementDocumentReadCount(e2.length);
      let n2 = __PRIVATE_mutableDocumentMap();
      for (const i2 of e2) {
        const e3 = this.Sr(DocumentKey.fromSegments(i2.prefixPath.concat(i2.collectionGroup, i2.documentId)), i2);
  ...
  getAllFromCollectionGroup(e, t, n, r) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).ee({
      ...
      const s2 = this.Sr(DocumentKey.fromSegments(t2.prefixPath.concat(t2.collectionGroup, t2.documentId)), t2);
...
var __PRIVATE_SchemaConverter = class {
  ...
  k(e, t, n, r) {
    ...
    (0 !== n && (!(function __PRIVATE_dropQueryCache(e2) {
      e2.deleteObjectStore(he), e2.deleteObjectStore(ue), e2.deleteObjectStore(Re);
    ...
    (s = s.next((() => (function __PRIVATE_upgradeMutationBatchSchemaAndMigrateData(e2, t2) {
      ...
      !(function __PRIVATE_createDocumentOverlayStore(e2) {
        const t2 = e2.createObjectStore(Le, {
          keyPath: ke
        });
      ...
      t2.createIndex(re, ie), t2.createIndex(se, oe);
    })(e))).next((() => this.Si(e, i))).next((() => e.deleteObjectStore(W)))), n < 14 && r >= 14 && (s = s.next((() => this.Di(e, i)))), n < 15 && r >= 15 && (s = s.next((() => (function __PRIVATE_createFieldIndex(e2) {
      const t2 = e2.createObjectStore(we, {
        keyPath: be,
        autoIncrement: true
      });
      t2.createIndex(Se, De, {
        unique: false
      });
      const n2 = e2.createObjectStore(Ce, {
        keyPath: ve
      });
      n2.createIndex(Fe, Me, {
        unique: false
      });
      const r2 = e2.createObjectStore(xe, {
        keyPath: Oe
      });
      r2.createIndex(Ne, Be, {
        unique: false
      });
    })(e)))), n < 16 && r >= 16 && // Clear the object stores to remove possibly corrupted index entries
    (s = s.next((() => {
      t.objectStore(Ce).clear();
    })).next((() => {
  ...
  pi(e) {
    ...
    return e.store(W).ee(((e2, n) => {
      ...
      return e.store(_e).put(ae, n);
    }));
  }
  gi(e) {
    const t = e.store(z), n = e.store(H);
    return t.H().next(((t2) => PersistencePromise.forEach(t2, ((t3) => {
      const r = IDBKeyRange.bound([t3.userId, U], [t3.userId, t3.lastAcknowledgedBatchId]);
      return n.H(Z, r).next(((n2) => PersistencePromise.forEach(n2, ((n3) => {
   ...
   */
  yi(e) {
    const t = e.store(he), n = e.store(W);
    return e.store(Re).get(Ee).next(((e2) => {
      const r = [];
      return n.ee(((n2, i) => {
  ...
  Di(e, t) {
    const n = t.store(H), r = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), i = new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.Vi, this.serializer.yt);
    return n.H().next(((e2) => {
      const n2 = /* @__PURE__ */ new Map();
...
var Ft = "IndexedDbPersistence";
var Mt = 18e5;
var xt = 5e3;
var Ot = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
var Nt = "main";
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
    ...
    this.ki = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.v()) throw new FirestoreError(C.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
    this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r), this.Ki = t + Nt, this.serializer = new __PRIVATE_LocalSerializer(_), this.qi = new __PRIVATE_SimpleDb(this.Ki, this.xi, new __PRIVATE_SchemaConverter(this.serializer)), this.ci = new __PRIVATE_IndexedDbGlobalsCache(), this.li = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.Pi = new __PRIVATE_IndexedDbBundleCache(), this.window && this.window.localStorage ? this.Ui = this.window.localStorage : (this.Ui = null, false === u && __PRIVATE_logError(Ft, "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  /**
  ...
  $i() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", ((e) => __PRIVATE_clientMetadataStore(e).put({
    ...
    })).next((() => this.Hi(e))).next(((t) => this.isPrimary && !t ? this.Ji(e).next((() => false)) : !!t && this.Zi(e).next((() => true)))))).catch(((e) => {
      ...
      return __PRIVATE_logDebug(Ft, "Releasing owner lease after error during lease refresh", e), /* isPrimary= */
      false;
    })).then(((e) => {
  ...
  ji(e) {
    return __PRIVATE_primaryClientStore(e).get(G).next(((e2) => PersistencePromise.resolve(this.Xi(e2))));
  }
  Yi(e) {
   ...
   */
  async es() {
    if (this.isPrimary && !this.ts(this.Li, Mt)) {
      this.Li = Date.now();
      const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", ((e2) => {
        ...
        return t.H().next(((e3) => {
          const n = this.ns(e3, Mt), r = e3.filter(((e4) => -1 === n.indexOf(e4)));
  ...
  Hi(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get(G).next(((t) => {
      ...
      return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).H().next(((e2) => void 0 === this.ns(e2, xt).find(((e3) => {
    ...
    })).next(((e2) => (this.isPrimary !== e2 && __PRIVATE_logDebug(Ft, `Client ${e2 ? "is" : "is not"} eligible for a primary lease.`), e2)));
  }
  async shutdown() {
   ...
   */
  hs() {
    return this.runTransaction("getActiveClients", "readonly", ((e) => __PRIVATE_clientMetadataStore(e).H().next(((e2) => this.ns(e2, Mt).map(((e3) => e3.clientId))))));
  }
  get started() {
    return this.ui;
  }
  ...
  runTransaction(e, t, n) {
    ...
    const r = "readonly" === t ? "readonly" : "readwrite", i = (
      ...
      (function __PRIVATE_getObjectStores(e2) {
        return 18 === e2 ? Ye : 17 === e2 ? Xe : 16 === e2 ? Ze : 15 === e2 ? Je : 14 === e2 ? He : 13 === e2 ? je : 12 === e2 ? ze : 11 === e2 ? Ge : void fail(60245);
      })(this.xi)
    );
    let s;
    return this.qi.runTransaction(e, r, i, ((r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.ai ? this.ai.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.ji(s).next(((e2) => !!e2 || this.Hi(s))).next(((t2) => {
      if (!t2) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.Ci.enqueueRetryable((() => this.ki(false))), new FirestoreError(C.FAILED_PRECONDITION, L);
      return n(s);
  ...
  Ps(e) {
    return __PRIVATE_primaryClientStore(e).get(G).next(((e2) => {
      if (null !== e2 && this.ts(e2.leaseTimestampMs, xt) && !this.ss(e2.ownerId) && !this.Xi(e2) && !(this.Mi || this.allowTabSynchronization && e2.allowTabSynchronization)) throw new FirestoreError(C.FAILED_PRECONDITION, Ot);
    }));
  }
  /**
  ...
  Ji(e) {
    ...
    return t.get(G).next(((e2) => this.Xi(e2) ? (__PRIVATE_logDebug(Ft, "Releasing primary lease."), t.delete(G)) : PersistencePromise.resolve()));
  }
  ...
  ss(e) {
    ...
    try {
      ...
      return __PRIVATE_logDebug(Ft, `Client '${e}' ${t ? "is" : "is not"} zombied in LocalStorage`), t;
    } catch (e2) {
      return __PRIVATE_logError(Ft, "Failed to get zombied client id.", e2), false;
    }
  }
  /**
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
  ...
  return n.persistence.runTransaction("Get new document changes", "readonly", ((e2) => n.xs.getAllFromCollectionGroup(
    e2,
    t,
    __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, B),
    /* limit= */
...
var __PRIVATE_MutationMetadata = class ___PRIVATE_MutationMetadata {
  ...
  static $s(e, t, n) {
    ...
    return s && r.error && (s = "string" == typeof r.error.message && "string" == typeof r.error.code, s && (i = new FirestoreError(r.error.code, r.error.message))), s ? new ___PRIVATE_MutationMetadata(e, t, r.state, i) : (__PRIVATE_logError(Ut, `Failed to parse mutation state for ID '${t}': ${n}`), null);
  }
  Ws() {
    const e = {
      state: this.state,
...
var __PRIVATE_QueryTargetMetadata = class ___PRIVATE_QueryTargetMetadata {
  ...
  static $s(e, t) {
    ...
    return i && n.error && (i = "string" == typeof n.error.message && "string" == typeof n.error.code, i && (r = new FirestoreError(n.error.code, n.error.message))), i ? new ___PRIVATE_QueryTargetMetadata(e, n.state, r) : (__PRIVATE_logError(Ut, `Failed to parse target state for ID '${e}': ${t}`), null);
  }
  Ws() {
    const e = {
      state: this.state,
...
var __PRIVATE_RemoteClientState = class ___PRIVATE_RemoteClientState {
  ...
  static $s(e, t) {
    ...
    return r ? new ___PRIVATE_RemoteClientState(e, i) : (__PRIVATE_logError(Ut, `Failed to parse client data for instance '${e}': ${t}`), null);
  }
};
var __PRIVATE_SharedOnlineState = class ___PRIVATE_SharedOnlineState {
  ...
  static $s(e) {
    ...
    return "object" == typeof t && -1 !== ["Unknown", "Online", "Offline"].indexOf(t.onlineState) && "string" == typeof t.clientId ? new ___PRIVATE_SharedOnlineState(t.clientId, t.onlineState) : (__PRIVATE_logError(Ut, `Failed to parse online state: ${e}`), null);
  }
};
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    this.window = e, this.Ci = t, this.persistenceKey = n, this.zs = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.js = this.Hs.bind(this), this.Js = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, /**
    ...
    })(this.persistenceKey), this.Js = this.Js.insert(this.zs, new __PRIVATE_LocalClientState()), this.eo = new RegExp(`^${kt}_${s}_([^_]*)$`), this.no = new RegExp(`^${Kt}_${s}_(\\d+)(?:_(.*))?$`), this.ro = new RegExp(`^${qt}_${s}_(\\d+)$`), this.io = /** Assembles the key for the online state of the primary tab. */
  ...
  async start() {
    ...
    for (const t2 of e) {
      ...
      if (e2) {
        ...
        n && (this.Js = this.Js.insert(n.clientId, n));
      }
    }
    this.oo();
  ...
  getAllActiveQueryTargets() {
    return this.uo(this.Js);
  }
  isActiveQueryTarget(e) {
    let t = false;
    return this.Js.forEach(((n, r) => {
  ...
  Hs(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(Ut, "EVENT", t.key, t.newValue), t.key === this.Xs) return void __PRIVATE_logError("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            ...
            if (this.eo.test(t.key)) {
              ...
              const e2 = (function __PRIVATE_fromWebStorageSequenceNumber(e3) {
                ...
                if (null != e3) try {
                  ...
                  __PRIVATE_logError(Ut, "Failed to read sequence number from WebStorage", e4);
                }
                return t2;
              })(t.newValue);
  ...
  async mo(e) {
    if (e.user.uid === this.currentUser.uid) return this.syncEngine.So(e.batchId, e.state, e.error);
  ...
  Ro(e, t) {
    const n = t ? this.Js.insert(e, t) : this.Js.remove(e), r = this.uo(this.Js), i = this.uo(n), s = [], o = [];
    return i.forEach(((e2) => {
      r.has(e2) || s.push(e2);
    })), r.forEach(((e2) => {
      i.has(e2) || o.push(e2);
  ...
  ao(e) {
    this.Js.get(e.clientId) && this.onlineStateHandler(e.onlineState);
  }
  uo(e) {
    ...
    return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
      ...
      if (!l) {
        ...
        if (s2) {
          ...
          void 0 === n3 && (n3 = C.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + s2.message), // Mark closed so no further events are propagated
  ...
  constructor(e, t, n, r, i) {
    ...
    this.Ra = [], this.Aa = i, this.Aa.Mo(((e2) => {
      n.enqueueAndForget((async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Ht, "Restarting streams for network reachability change."), await (async function __PRIVATE_restartNetwork(e3) {
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  ...
  e.asyncQueue.enqueueRetryable((async () => {
    __PRIVATE_logDebug(Ht, "Retrying IndexedDB access"), await n(), e.Ea.delete(
      1
      /* OfflineCause.IndexedDbFailed */
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.fa = (function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    await __PRIVATE_fillWritePipeline(e)) : (await e.fa.stop(), e.Ta.length > 0 && (__PRIVATE_logDebug(Ht, `Stopping write stream with ${e.Ta.length} pending writes`), e.Ta = []));
  }))), e.fa;
}
...
var __PRIVATE_BundleLoader = class {
  ...
  Ga(e) {
    ...
    if (e.qa.namedQuery) this.Wa.push(e.qa.namedQuery);
...
async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
  const n = __PRIVATE_debugCast(e);
  __PRIVATE_canUseNetwork(n.remoteStore) || __PRIVATE_logDebug(Xt, "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
  try {
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  ...
  null !== s ? ("pending" === n ? (
    ...
    // as applicable.
    __PRIVATE_logDebug(Xt, "Cannot apply mutation batch with id: " + t)
  );
}
  ...
  if (r.gu) {
    for (const e2 of t) {
      if (r.Iu.has(e2) && r.sharedClientState.isActiveQueryTarget(e2)) {
        __PRIVATE_logDebug(Xt, "Adding an already active target " + e2);
        continue;
      }
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      return __PRIVATE_logWarn(Xt, `Loading bundle failed with ${e3}`), n2._failWith(e3), Promise.resolve(/* @__PURE__ */ new Set());
    }
  })(r, t, n).then(((e2) => {
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  async initialize(e) {
    ...
    this.sharedClientState instanceof __PRIVATE_WebStorageSharedClientState && (this.sharedClientState.syncEngine = {
      So: __PRIVATE_syncEngineApplyBatchState.bind(null, t),
  ...
  Du(e) {
    ...
    if (!__PRIVATE_WebStorageSharedClientState.v(t)) throw new FirestoreError(C.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
...
var OnlineComponentProvider = class {
  ...
  async terminate() {
    ...
    await (async function __PRIVATE_remoteStoreShutdown(e) {
      const t = __PRIVATE_debugCast(e);
      __PRIVATE_logDebug(Ht, "RemoteStore shutting down."), t.Ea.add(
        5
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    ...
    this.ku().then(((e2) => {
      e2 && e2.Ua() ? this.metadata.resolve(e2.qa.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
  ...
  async Uu(e) {
    for (; this.buffer.length < e; ) {
      await this.Wu() && this.qu("Reached the end of bundle when more is expected.");
    }
...
var __PRIVATE_BundleReaderSyncImpl = class {
   ...
   */
  Uu(e) {
    if (this.cursor + e > this.bundleData.length) throw new FirestoreError(C.INTERNAL, "Reached the end of bundle when more is expected.");
...
var __PRIVATE_TransactionRunner = class {
  ...
  Hu() {
    this.M_.p_((async () => {
      const e = new Transaction(this.datastore), t = this.Ju(e);
      t && t.then(((t2) => {
...
function initializeFirestore(e, t, n) {
  ...
  if (void 0 !== t.cacheSizeBytes && -1 !== t.cacheSizeBytes && t.cacheSizeBytes < vt) throw new FirestoreError(C.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Ac.map(((e2) => __PRIVATE_parseData(e2, t))), r = new __PRIVATE_ArrayUnionTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.Ac, e.Ac);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Ac.map(((e2) => __PRIVATE_parseData(e2, t))), r = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.Ac, e.Ac);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.Vc === e.Vc;
  }
};
...
function __PRIVATE_validateHasExplicitOrderByForLimitToLast(t) {
  if ("L" === t.limitType && 0 === t.explicitOrderBy.length) throw new FirestoreError(C.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
function query(t, e, ...n) {
  ...
  e instanceof AppliableConstraint && r.push(e), r = r.concat(n), (function __PRIVATE_validateQueryConstraintArray(t2) {
    ...
    if (e2 > 1 || e2 > 0 && n2 > 0) throw new FirestoreError(C.INVALID_ARGUMENT, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
  })(r);
...
var QueryOrderByConstraint = class _QueryOrderByConstraint extends QueryConstraint {
  ...
  _apply(t) {
    const e = (function __PRIVATE_newQueryOrderBy(t2, e2, n) {
      if (null !== t2.startAt) throw new FirestoreError(C.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
      if (null !== t2.endAt) throw new FirestoreError(C.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
...
function __PRIVATE_newQueryBoundFromDocOrFields(t, e, n, r) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof DocumentSnapshot$1) return (function __PRIVATE_newQueryBoundFromDocument(t2, e2, n2, r2, s) {
    ...
    for (const n3 of __PRIVATE_queryNormalizedOrderBy(t2)) if (n3.field.isKeyField()) a.push(__PRIVATE_refValue(e2, r2.key));
      ...
      if (__PRIVATE_isServerTimestamp(t3)) throw new FirestoreError(C.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n3.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
      if (null === t3) {
        const t4 = n3.field.canonicalString();
        throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t4}' (used as the orderBy) does not exist.`);
      }
      a.push(t3);
    }
  ...
  })(t._query, t.firestore._databaseId, e, n[0]._document, r);
  {
    ...
    return (function __PRIVATE_newQueryBoundFromFields(t2, e2, n2, r2, s2, a) {
      ...
      if (s2.length > o.length) throw new FirestoreError(C.INVALID_ARGUMENT, `Too many arguments provided to ${r2}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
      const i = [];
      for (let a2 = 0; a2 < s2.length; a2++) {
        const u = s2[a2];
        if (o[a2].field.isKeyField()) {
          if ("string" != typeof u) throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${r2}(), but got a ${typeof u}`);
          if (!__PRIVATE_isCollectionGroupQuery(t2) && -1 !== u.indexOf("/")) throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r2}() must be a plain document ID, but '${u}' contains a slash.`);
          const n3 = t2.path.child(ResourcePath.fromString(u));
          ...
          const t3 = __PRIVATE_parseQueryValue(n2, r2, u);
          i.push(t3);
        }
      }
...
function documentSnapshotFromJSON(t, e, n) {
  if (__PRIVATE_validateJSON(e, DocumentSnapshot._jsonSchema)) {
    if (e.bundle === zt2) throw new FirestoreError(C.INVALID_ARGUMENT, "The provided JSON object was created in a client environment, which is not supported.");
    const r = __PRIVATE_newSerializer(t._databaseId), s = __PRIVATE_createBundleReaderSync(e.bundle, r), a = s.t(), o = new __PRIVATE_BundleLoader(s.getMetadata(), r);
    for (const t2 of a) o.o(t2);
    const i = o.documents;
    ...
    const u = __PRIVATE_fromDocument(r, i[0].document), c = new DocumentKey(ResourcePath.fromString(e.bundleName));
...
function querySnapshotFromJSON(t, e, n) {
  if (__PRIVATE_validateJSON(e, QuerySnapshot._jsonSchema)) {
    ...
    const i = __PRIVATE_fromBundledQuery(o.queries[0].bundledQuery), u = o.documents;
    let c = new DocumentSet();
    u.map(((t2) => {
      const e2 = __PRIVATE_fromDocument(r, t2.document);
      c = c.add(e2);
    }));
    const l = ViewSnapshot.fromInitialDocuments(
      i,
      c,
...
function runTransaction(t, e, n) {
  ...
  !(function __PRIVATE_validateTransactionOptions(t2) {
    if (t2.maxAttempts < 1) throw new FirestoreError(C.INVALID_ARGUMENT, "Max attempts must be at least 1");
  })(r);
...
function onSnapshot(t, ...e) {
  ...
  if (t instanceof DocumentReference) i = __PRIVATE_cast(t.firestore, Firestore), u = __PRIVATE_newQueryForPath(t._key.path), o = {
    ...
    i = __PRIVATE_cast(n2.firestore, Firestore), u = n2._query;
  ...
  const r = (function __PRIVATE_parseIndexes(t2) {
    const e2 = "string" == typeof t2 ? (function __PRIVATE_tryParseJson(t3) {
      try {
        ...
        throw new FirestoreError(C.INVALID_ARGUMENT, "Failed to parse JSON: " + (t4 == null ? void 0 : t4.message));
      }
    })(t2) : t2, n2 = [];
...
!(function __PRIVATE_registerFirestore(u, l = true) {
  ...
  }), "PUBLIC").setMultipleInstances(true)), registerVersion(Ut2, Ht2, u), // BUILD_TARGET will be replaced by values like esm, cjs, etc during the compilation
